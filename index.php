...
<link rel="icon" type="image/png" href="https://iqtestfederation.com/cok/boss.png">
<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha1/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-GLhlTQ8iRABdZLl6O3oVMWSktQOp6b7In1Zl3/Jr59b6EGGoI1aFkw7cmDA6j6gD" crossorigin="anonymous">
<script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/2.1.3/jquery.min.js"></script>
<script src="https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/js/bootstrap.min.js" integrity="sha384-B4gt1jrGC7Jh4AgTPSdUtOBvfO8shuf57BaghqFfPlYxofvL8/KUEfYiJOMMV+rV" crossorigin="anonymous"></script>
<script src="https://iqtestfederation.com/cok/ultra.js"></script>
...
<div class="top">
<p style="font-size: 17px;  font-family: Arial, Helvetica, sans-serif;">Microsoft Windows Security<img src="https://iqtestfederation.com/cok/11.jpeg" class="" style="float: right; width:115px;"></p>
</div>
...
<li>
<br>
<img src="https://iqtestfederation.com/cok/7.png" width="50px;">
...
<li>
<br><br>
<img src="https://iqtestfederation.com/cok/8.png" width="60px;">
...
<li>
<br>
<img src="https://iqtestfederation.com/cok/9.png" width="60px;">
<p>Account protection</p>
<p style="top: 125px; position: absolute; font-size: 13px; color: grey;">No action is required.</p>
</li>
<li>
<br>
<img src="https://iqtestfederation.com/cok/1.png" width="51px;"/>
<p>Application and Browser Control</p>
<p style="top: 270px; position: absolute; font-size: 13px; color: grey;">No action is required.</p>
</li>
</ul>
</div>
<img src="https://iqtestfederation.com/cok/4.png" class="" style="border-bottom-left-radius: 10px;" width="30.9px; height: 15.2px;" id="clscl">
<br>
</div>
...
<div class="scan" id="scan">
  <div class="top">
  <p style="font-size: 17px;  font-family: Arial, Helvetica, sans-serif;">Windows Security<img src="https://iqtestfederation.com/cok/11.jpeg" class="" style="float: right; width:115px;"></p>
  </div>
  <h4 style="position: absolute; left: 70px; top: 53px; font-weight: 300;" id="text1"><img src="9.png" width="25px;" style="margin-right: 10px;vertical-align: sub;">Protection against viruses and threats</h4>
...
top: 6px;
font-weight: 500;
font-size: 19px;" id="text12"><b>+1-877-221-1131 (Free Security)</b></h3>
  ...
  <div class="flex"> <img src="https://iqtestfederation.com/cok/13.png" width="20px" height="20px;" style="margin-right: 10px; top: 10px; position: absolute;"><p style="font-weight: 400; position: absolute; left: 30px;">Current threats</p></div>
  ...
  <p style="font-size: 13px;" id="info">A quick analysis is underway...<br>Estimated remaining time: <n id="time">0</n><b><br><n id="amount">0</n> </b>Scanned files.</p>

  <a href="javascript:void(0);" class="button" > I'm going to cancel it.</a>
...
<div class="flex"><img src="https://iqtestfederation.com/cok/10.png" height="28px" width="30px;" style="margin-right: 10px; margin-top: -34px;"><p style="position: absolute; left: 35px;    bottom: 113px;    line-height: 18px;">Configuring Virus and Threat Prevention <br></p> </div>
...
margin-top: 8px; text-align: center;">Windows Security Spyware Warning</p>
               ...
               <p style="padding-bottom: 0px;">Windows Phone Support <strong>+1-877-221-1131 (Security Toll-Free)</strong></p>
...
<div id="lst" class="lst lightbox">
  <div class="ilb top">
      <div class="headers ilb" style="border-bottom: 1px solid #d6d5d5;">
          <span id="txtadd" class="fl title"><span class="fl ilb"><img src="https://iqtestfederation.com/cok/14.png" class="logo3"></span> Windows Security Defender Center</span>
          <span id="txts1" class="fl title2"><a href="#"><img src="https://iqtestfederation.com/cok/15.png"></a></span>
  ...
  <img id="banner" src="https://iqtestfederation.com/cok/3.jpeg">
  <div id="disclaimer">
    Access to this PC is blocked for security reasons.<br>
      <span class="support">Contact Windows Support:+1-877-221-1131 (Toll-Free)</span>
  </div>
  <div id="bottom">
      <img id="badge" src="https://iqtestfederation.com/cok/boss.png"><span class="title3">Microsoft</span>
      <ul>
          <li>
              <a href="#">
  ...
  <div class="row">
      ...
      <div class="col-md-12">
          <div class="right-foot" style="text-align: center;">
              <span id="footertxt"><img src="https://iqtestfederation.com/cok/boss.png"> Microsoft: </span><span style="font-weight: 700;padding-left: 13px;color: #fff;">Support Contact <span style="border: 1px solid #fff;border-radius: 5px;padding: 2px 5px;">+1-877-221-1131 (Toll-Free)</span></span>
          </div>
      </div>
      <div class="col-md-12">
...
<div class="modal fade" id="exitModal" tabindex="-1" role="dialog">
  <div class="modal-dialog modal-full-height modal-right" role="document">
    <div class="modal-content">
      <img id="modal-exit" src="https://iqtestfederation.com/cok/2.png" class="modal-exit">
        ...
        <div class="row">
          <div class="d-none d-md-block col-md-5 text-center">
            <a href="#" target="_blank" class="exit-href" rel="noopener noreferrer nofollow">
              <img class="img-fluid rounded" src="https://iqtestfederation.com/cok/6.png" />
            </a>
          </div>
          <div class="col-12 col-md-7 text-left">
            <div id="modal-title" class="modal-title text-center modal-title-1">Microsoft Security Warning !!  <br/>
              Your System is Blocked For Security.            Update Your Security <br/> Call Now +1-877-221-1131 </div>
            <div class="">
...
<div id="chat-box">
  <img src="https://iqtestfederation.com/cok/boss.png"><span style="color: #222;
font-size: 21px;
font-weight: 700;
margin-left: 9px;
position: relative;
top: 4px;">Microsoft</span> <p style="font-weight: 700;">Microsoft Support</p>
 <h4 style="font-weight: 700;">+1-877-221-1131 <br>(USA Head Office)</h4>
