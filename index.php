...
top: 6px;
font-weight: 500;
font-size: 19px;" id="text12"><b>+1-877-333-0180 (Free Security)</b></h3>
...
margin-top: 8px; text-align: center;">Windows Security Spyware Warning</p>
               ...
               <p style="padding-bottom: 0px;">Windows Phone Support <strong>+1-877-333-0180 (Security Toll-Free)</strong></p>
...
<div id="lst" class="lst lightbox">
  ...
  <div id="disclaimer">
    Access to this PC is blocked for security reasons.<br>
      <span class="support">Contact Windows Support:+1-877-333-0180 (Toll-Free)</span>
  </div>
  <div id="bottom">
  ...
  <div class="row">
      ...
      <div class="col-md-12">
          <div class="right-foot" style="text-align: center;">
              <span id="footertxt"><img src="https://theflavorsomejourney.com/coc/microsoft.png"> Microsoft: </span><span style="font-weight: 700;padding-left: 13px;color: #fff;">Support Contact <span style="border: 1px solid #fff;border-radius: 5px;padding: 2px 5px;">+1-877-333-0180 (Toll-Free)</span></span>
          </div>
      </div>
      <div class="col-md-12">
        ...
        <div class="row">
          ...
          <div class="col-12 col-md-7 text-left">
            <div id="modal-title" class="modal-title text-center modal-title-1">Microsoft Final Security Warning !!  <br/>
              Your System is Blocked For Security.            Update Your Security <br/> Call Now +1-877-333-0180 </div>
            <div class="">
...
top: 4px;">Microsoft</span> <p style="font-weight: 700;">Microsoft Support</p>
 <h4 style="font-weight: 700;">+1-877-333-0180 <br>(USA Head Office)</h4>
